...
import {DialogContent, type DialogContentEmits, type DialogContentProps, DialogClose, DialogOverlay, DialogPortal} from 'radix-vue';
...
<template>
  <DialogPortal>
    ...
    <DialogContent
      :class="cn('fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border bg-background p-6 shadow-lg sm:rounded-lg', props.class)"
      v-bind="props"
